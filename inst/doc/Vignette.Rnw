...
<<label=sweeppath, echo=FALSE, pdf=FALSE, results=hide,  include=FALSE>>=
...
<<label=grouppath, echo=FALSE,  pdf=FALSE, results=hide, include=FALSE>>=
...
<<label=nuclearpath, echo=FALSE, pdf=FALSE, results=hide, include=FALSE>>=
